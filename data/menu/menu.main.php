<?php
	...
	$MENU['sitemap']['mapc']['_sub']['view']['_title'] = '위키 글보기';
	$MENU['sitemap']['mapc']['_sub']['view']['_link']  = $MODULE_MAPC_URL['view'];
	$MENU['sitemap']['mapc']['_sub']['edit']['_title'] = '위키 글쓰기/편집';
	$MENU['sitemap']['mapc']['_sub']['edit']['_link']  = $MODULE_MAPC_URL['edit'];
	$MENU['sitemap']['mapc']['_sub']['list']['_title'] = '위키 리스트';
	$MENU['sitemap']['mapc']['_sub']['list']['_link']  = $MODULE_MAPC_URL['list'];
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][0]['_title'] = '주제별';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][0]['_link']  = $MODULE_MAPC_URL['list'].'&mapc_cate=subject';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][1]['_title'] = '형식별';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][1]['_link']  = $MODULE_MAPC_URL['list'].'&mapc_cate=format';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][2]['_title'] = '유형별';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][2]['_link']  = $MODULE_MAPC_URL['list'].'&mapc_cate=type';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][3]['_title'] = '날짜별';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][3]['_link']  = $MODULE_MAPC_URL['list'].'&mapc_cate=date';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][4]['_title'] = '범위별';
	$MENU['sitemap']['mapc']['_sub']['list']['_sub'][4]['_link']  = $MODULE_MAPC_URL['list'].'&mapc_cate=coverage';
